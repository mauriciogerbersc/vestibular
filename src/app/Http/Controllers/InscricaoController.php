...
class InscricaoController extends Controller
{
    ...
    public function payment(Request $request, CadastroInscrito $cadastrarInscrito){
        ...
        $messages = [
            ...
            'historico_escolar.mimes' => 'O arquivo enviado deve ter as seguintes extensões: doc, docx, pdf, png, img.',
            'historico_escolar.max'  => 'O arquivo deve ter no máximo 30 MB',
